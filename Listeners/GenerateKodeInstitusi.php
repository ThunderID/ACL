...
use Thunderlabid\ACL\Models\Institusi;

class GenerateKodeInstitusi
{
	/**
	...
	/**
	 * Handle event
	 * @param  InstitusiCreated $event [description]
	...
	protected function generate()
	{
		...
		$prev_data		= Institusi::where('kode', 'like', $first_letter.'%')->orderby('kode', 'desc')->first();
